...
exports["default"] = exports.resetDeletePostStatus = exports.resetPostSlice = exports.resetcreatePostStatus = exports.postSlice = exports.deletePostFunction = exports.addCommentFunction = exports.unLikePostFunction = exports.likePostFunction = exports.getUserPosts = exports.getAllPosts = exports.createPost = void 0;
...
var deletePostFunction = (0, _toolkit.createAsyncThunk)("posts/deletePostFunction", function _callee7(postId, _ref9) {
  var fulfillWithValue, rejectWithValue, response;
  return regeneratorRuntime.async(function _callee7$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          fulfillWithValue = _ref9.fulfillWithValue, rejectWithValue = _ref9.rejectWithValue;
          _context7.next = 3;
          return regeneratorRuntime.awrap((0, _apiCall.apiCall)("DELETE", "post/".concat(postId)));
        ...
        case 3:
          ...
          return _context7.abrupt("return", fulfillWithValue(response));

        case 8:
          return _context7.abrupt("return", rejectWithValue(response));
...
exports.deletePostFunction = deletePostFunction;
var postSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    resetDeletePostStatus: function resetDeletePostStatus(state) {
  ...
  extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, getAllPosts.pending, function (state) {
  ...
  }), _defineProperty(_extraReducers, deletePostFunction.pending, function (state) {
    state.deletePostStatus = "loading";
  }), _defineProperty(_extraReducers, deletePostFunction.fulfilled, function (state, action) {
    var deletedPostId = action.payload.data.deletedPostId;
    ...
    state.userPosts = state.posts.filter(function (item) {
      if (item._id === deletedPostId) {
        return false;
      }
    ...
    (0, _localStorage.removePostLocal)(deletedPostId);
    state.deletePostStatus = "fullfilled";
  }), _defineProperty(_extraReducers, deletePostFunction.rejected, function (state, action) {
...
var _postSlice$actions = postSlice.actions,
    ...
    resetDeletePostStatus = _postSlice$actions.resetDeletePostStatus;
exports.resetDeletePostStatus = resetDeletePostStatus;
